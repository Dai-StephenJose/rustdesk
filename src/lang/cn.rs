...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Website", "网站"),
        ("About", "关于"),
        ("Slogan_tip", "任何人的私生活、家庭、住宅和通信不得任意干涉，他的荣誉和名誉不得加以攻击。人人有权享受法律保护，以免受这种干涉或攻击。"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep GoDesk background service", "保持 GoDesk 后台服务"),
        ...
        ("View camera", "查看摄像头"),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "请在远程端将 GoDesk 客户端升级至版本 {} 或更新版本！"),
