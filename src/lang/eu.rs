...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "GoDesk sarera konektatzen..."),
        ...
        ("Website", "Webgunea"),
        ("About", "Honi buruz"),
        ("Slogan_tip", "No one shall be subjected to arbitrary interference with his privacy, family, home or correspondence, nor to attacks on his honour and reputation. Everyone has the right to the protection of the law against such interference or attacks."),
        ...
        ("install_tip", "Erabiltzaile Kontuen Kontrolarengatik, GoDesk ezin du ondo funtzionatu urruneko mahaigainean. EKK saihesteko, mesedez, egin klik azpiko botoian GoDesk sistema mailan instalatzeko."),
        ...
        ("config_acc", "Zure mahaigaina urrunetik kontrolatzeko, GoDesk-i \"Irisgarritasuna\" baimenak eman behar dituzu."),
        ("config_screen", "Zure mahaigaina kanpotik kontrolatzeko, GoDesk-i \"Pantaila grabatu\" baimena eman behar duzu."),
        ...
        ("android_input_permission_tip1", "Urruneko gailu batek zure Android gailua saguaren edo ukipenaren bidez kontrolatzeko, GoDesk \"Irisgarritasuna\" zerbitzua erabiltzeko baimena eman behar diozu."),
        ("android_input_permission_tip2", "Joan hurrengo irekiko den sistemaren konfigurazio orrira, bilatu eta sartu [Instalatutako zerbitzuak], aktibatu [GoDesk Input] zerbitzua."),
        ...
        ("Turned off", "Itzalita"),
        ("Language", "Hizkuntza"),
        ("Keep GoDesk background service", "Mantendu GoDesk atzeko planoko zerbitzu bezala"),
        ("Ignore Battery Optimizations", "Ezikusi bateria optimizazioak"),
        ("android_open_battery_optimizations_tip", "Ezaugarri hau desgaitu nahi baduzu, joan zaitez GoDesk aplikazioaren ezarpen orrira, bilatu eta saltu [Bateria] orrira eta kendu [Mugarik gabe]"),
        ...
        ("config_input", "Urruneko mahaigaina teklatuaren bidez kontrolatzeko, GoDesk-i \"Sarrera monitorizazioa\" baimena eman behar diozu."),
        ("config_microphone", "Urrunetik hitz egin ahal izateko, GoDeski-i \"Grabatu audioa\" baimena eman behar diozu."),
        ...
        ("still_click_uac_tip", "Oraindik beharrezkoa da urruneko erabiltzaileak Ondo botoiari klik egitea exekutatzen ari den GoDesk UAC leihoan"),
        ...
        ("verify_rustdesk_password_tip", "Berretsi GoDesk pasahitza"),
        ...
        ("scam_text1", "Ezagutzen eta fidatzen EZ duzun norbaitekin telefonoz bazaude eta GoDesk erabiltzeko eta zerbitzua abiarazteko eskatu badizute, ez ezazu egin eta eskegi berehala."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Mesedez, bertsio-berritu GoDesk Server Pro {} bertsiora edo berriago batera!"),
        ...
        ("selinux_tip", "SELinux zure gailuan gaituta dago. Honek GoDesk kontrolatutako alde gisa dagoenean behar bezala ez exekutatzea ekarri dezake."),
        ...
        ("allow-only-conn-window-open-tip", "Baimendu konexioa GoDesk leihoa irekita badago"),
        ...
        ("floating_window_tip", "GoDesk atzeko planoko zerbitzua mantentzen laguntzen du"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Mesedez, eguneratu GoDesk bezeroa {} bertsiora edo berriagoa urruneko aldean!"),
